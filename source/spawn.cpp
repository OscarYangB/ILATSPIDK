...
entt::entity spawn_player() {
	...
	add_component(entity, CharacterDataComp{.starting_health = 150.f, .type = CharacterType::GOOD,
...
entt::entity spawn_grakeny() {
	...
	add_component(entity, CharacterDataComp{.starting_health = 800.f, .type = CharacterType::EVIL, .starting_deck = make_cards({ })});
	return entity;
}
